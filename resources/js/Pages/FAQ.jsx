    ...
    return (
        <>
            ...
            <div  className='flex flex-col items-center text-center text-slate-800 px-3'>
                <p   className='text-base text-blue-400 font-medium text-slate-600'>FAQ</p>
                <h1 style={{color:'grey'}} className='text-3xl   md:text-4xl font-semibold mt-2'>Frequently Asked Questions</h1>
                <p className='text-sm text-blue-400 text-slate-500 mt-4 max-w-sm'>
                    Proactively answering FAQs boosts user confidence and cuts down on support tickets.
                </p>
                <div style={{color:'grey'}} className='max-w-xl w-full mt-6 flex flex-col gap-4 items-start text-left'>
