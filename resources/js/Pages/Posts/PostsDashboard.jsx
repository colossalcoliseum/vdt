                    ...
                    <div className="overflow-hidden bg-[#283148] shadow-sm sm:rounded-lg">
                        <div className="p-6 text-white/50">
                            ...
                            <div className="grid gap-6 lg:grid-cols-3 lg:grid-rows-3 lg:gap-5">
                                ...
                                <a
                                    href={route('post.show',post.id)}/*TODO: refresh при отваряне на линк? */
                                    className="flex rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                >
                                    <div
                                        className="flex size-12 shrink-0 items-center justify-center rounded-full bg-white/50 sm:size-16">
                                        <img src={post.creator.avatar} className="rounded-full" alt={post.creator.name}>

                                        </img>
                                    </div>

                                    <div className="mx-auto my-auto px-3">
