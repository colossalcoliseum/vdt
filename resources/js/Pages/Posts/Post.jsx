                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 ">
                    <div className="grid grid-cols-12 grid-rows-12">
                        <div className="col-span-12 mx-auto row-span-6">
                            <h1 className="font-mono overflow-y-auto font-bold text-white ">{post.title}</h1>
                            <ul className="space-y-2 font-medium border-t border-gray-200"/>
                            <span
                                className="font-mono overflow-y-auto font-bold text-white">Written by {post.creator.name}</span>
                    ...
                    <div className="grid grid-cols-12 grid-rows-12">
                        <div className="col-span-full mx-auto row-span-10">
                            <img src={post.thumbnail} alt={post.title} width={500}
                                 className="rounded-sm border-x-4 border-y-4 border-gray-900"/>
                        </div>
                    </div>
                    <div className="grid grid-cols-12 grid-rows-12">
                        <div className="col-span-6 mx-auto row-span-full">
                            <p className="font-mono overflow-y-auto text-white ">{post.description}</p>
                        </div>
