                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-1 lg:justify-center">
                               <ApplicationLogo className="h-14 fill-current text-blue-900"></ApplicationLogo>
                            </div>
                            <nav className="-mx-3 flex flex-1 justify-end">
                                <Link
                                    href={route('dashboard')}
                                    className="rounded-md px-3 py-2 text-gray-900 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none dark:focus-visible:ring-white"
                                >
                                    Home
                                </Link>
                                <Link
                                ...
                                {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:hover:text-gray-300 dark:focus-visible:ring-white"
                                        >
                                            Log in
                                        </Link>
                                        <Link
                        ...
                        <main className="mt-6">
                            <div className="flex items-center my-12 text-3xl justify-center gap-2">
                            ...
                            <div className="grid gap-6 lg:grid-cols-3 lg:grid-rows-3 lg:gap-5">
                                ...
                                <a
                                    href=""
                                    className="flex items-start col-span-2 gap-4 rounded-sm bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                >
                                    <div
                                ...
                                <a
                                    href="https://laravel-news.com"
                                    className="flex items-start col-span-1 gap-4 rounded-sm bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                >
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
