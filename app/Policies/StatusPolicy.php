...
class StatusPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any Status');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any Status');
    }
    ...
    {
        return $user->checkPermissionTo('replicate Status');
    }
    ...
    {
        return $user->checkPermissionTo('reorder Status');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any Status');
    }
}
